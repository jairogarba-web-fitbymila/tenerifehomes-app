...
export default function HomePage() {
  ...
  useEffect(() => {
    // Rotating hero phrases â slow cinematic
    ...
    <>
      ...
      <style jsx global>{`
        ...
        *::after {
        ...
        /* âââ SHOWCASE BLOCKS â EACH IS A CINEMA FRAME âââ */
        .frame {
          min-height: 100vh;
          display: grid;
        ...
        /* âââ PRICING HORIZONTAL âââ */
        .pricing {
          padding: 6rem 3rem;
        }
        .pricing-header {
      ...
      <section className="hero">
        <div className="hero-bg">
          <img
            ...
            alt="Profesionales inmobiliarios en oficina moderna con vistas panorÃ¡micas"
          />
          <div
            style={{
              position: 'absolute',
        ...
        <div className="hero-c">
          ...
          <p>
            Web profesional, CRM, distribuciÃ³n a 11 portales y gestiÃ³n de
      ...
      <section className="frame" id="features">
        ...
        <div className="frame-body">
          ...
          <p>
            Elige entre diseÃ±os luxury, mediterrÃ¡neo, corporate, boutique y
            mÃ¡s. Personaliza colores, logo y dominio propio. Lista en 10
            minutos.
          </p>
      ...
      <section className="frame reverse">
        ...
        <div className="frame-body">
          ...
          <div className="frame-highlights">
            <span className="highlight-chip">SincronizaciÃ³n automÃ¡tica</span>
      ...
      <section className="frame">
        ...
        <div className="frame-body">
          ...
          <p>
            ...
            Comisiones automÃ¡ticas y transparentes entre profesionales.
          </p>
          <div className="frame-highlights">
      ...
      {/* âââ FRAME 4: ALQUILERES âââ */}
      <section className="frame reverse">
        <div className="frame-img">
          <img
            src="https://images.unsplash.com/photo-1556741533-6e6a62bd8b49?w=1200&q=80"
            alt="GestiÃ³n de alquileres vacacionales en laptop"
          />
          <div
            className="overlay-gradient"
            style={{
        ...
        <div className="frame-body">
          ...
          <p>
            Calendario unificado, sync con Airbnb y Booking, pricing dinÃ¡mico
            con IA, gestiÃ³n de limpiezas e informes al propietario.
          </p>
          <div className="frame-highlights">
      ...
      <section className="frame">
        ...
        <div className="frame-body">
          ...
          <p>
            Captura, seguimiento y conversiÃ³n. Email marketing segmentado.
            Analytics en tiempo real. Todo en un panel unificado.
          </p>
          <div className="frame-highlights">
            <span className="highlight-chip">Leads automÃ¡ticos</span>
            <span className="highlight-chip">Email marketing</span>
            <span className="highlight-chip">Informes de conversiÃ³n</span>
            <span className="highlight-chip">SegmentaciÃ³n por perfil</span>
          </div>
          <a href="#" className="link-arrow">
            Ver CRM
          </a>
      ...
      {/* âââ FRAME 6: PROFESIONALES âââ */}
      <section className="frame reverse">
        <div className="frame-img">
          <img
      ...
      <section className="gallery" id="plantillas">
        ...
        <p>7 diseÃ±os para 7 perfiles de agente</p>
        <div className="gallery-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
            <a href="/demos/luxury" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=500&q=80" alt="Luxury" />
              <div className="gal-cap"><span>Premium</span><h4>Luxury</h4></div>
            </a>
            <a href="/demos/mediterranean" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=500&q=80" alt="Mediterranean" />
              <div className="gal-cap"><span>Cálido</span><h4>Mediterranean</h4></div>
            </a>
            <a href="/demos/corporate" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=500&q=80" alt="Corporate" />
              <div className="gal-cap"><span>Profesional</span><h4>Corporate</h4></div>
            </a>
            <a href="/demos/boutique" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=500&q=80" alt="Boutique" />
              <div className="gal-cap"><span>Exclusivo</span><h4>Boutique</h4></div>
            </a>
            <a href="/demos/classic" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=500&q=80" alt="Classic" />
              <div className="gal-cap"><span>Clásico</span><h4>Classic</h4></div>
            </a>
            <a href="/demos/network" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=500&q=80" alt="Network" />
              <div className="gal-cap"><span>Multi-oficina</span><h4>Network</h4></div>
            </a>
            <a href="/demos/data" className="gal-item" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&q=80" alt="Data-Driven" />
              <div className="gal-cap"><span>Analytics</span><h4>Data-Driven</h4></div>
            </a>
            <a href="/demos" className="gal-item" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(201,168,76,0.05)', border: '1px solid rgba(201,168,76,0.2)' }}>
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                <div style={{ fontSize: '2rem', color: 'var(--gold)', marginBottom: '0.5rem' }}>→</div>
                <h4 style={{ fontFamily: 'var(--serif)', fontSize: '1.2rem' }}>Ver todas</h4>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-light)' }}>7 demos interactivas</span>
              </div>
            </a>'use client';
      ...
      <section className="pricing" id="precios">
        ...
        <div className="price-row">
          <div className="p-card">
            ...
            <div className="p-sub">+ IGIC Â· Para agentes independientes</div>
            <ul className="p-list">
          ...
          <div className="p-card featured">
            ...
            <div className="p-sub">+ IGIC Â· El mÃ¡s elegido</div>
            <ul className="p-list">
          ...
          <div className="p-card">
            ...
            <div className="p-sub">+ IGIC Â· Sin lÃ­mites</div>
            <ul className="p-list">
              <li>Ilimitadas</li>
              <li>11 portales</li>
              <li>MLS completo</li>
          ...
          <div className="p-card">
            ...
            <div className="p-sub">+ IGIC Â· Multi-agente</div>
            <ul className="p-list">
              <li>Todo Premium</li>
              <li>15 agentes</li>
